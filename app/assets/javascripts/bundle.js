	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'header',
	        { className: '' },
	        React.createElement(LoggedOutHeader, null)
	      ),
	      React.createElement(
	        'h1',
	        null,
	        'You have reached the root rendered by React'
	      )
	    );
	  }
	});
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "td",
	            null,
	            React.createElement("input", { className: "login-input", type: "text", name: "user[email]" })
	          ),
	          React.createElement(
	            "td",
	            null,
	            React.createElement("input", { className: "login-input", type: "password", name: "user[password]" })
	          ),
	          React.createElement(
	            "td",
	            null,
